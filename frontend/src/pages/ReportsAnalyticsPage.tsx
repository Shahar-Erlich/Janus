...
const COLORS = ['#a855f7', '#c084fc', '#7c3aed', '#581c87', '#d8b4fe'];
  ...
  return (
    <div className="page-stack">
      <section className="page-hero-row events-hero-row">
        <div>
          ...
          <p className="page-section-subtitle">
            Operational trends, protocol breakdown, and offender intelligence derived from the Janus protobuf stream.
          </p>
        </div>
      </section>
      ...
      <section className="reports-grid-top">
        <SectionCard
          title="Traffic Intelligence Trends"
          subtitle="Inbound vs allowed packet trend"
        ...
        <SectionCard
          ...
          subtitle="Protocol activity share"
          className="reports-donut-card"
        >
          <div className="protocol-layout">
            <div className="donut-chart-wrapper">
              ...
              <div className="donut-center">
                <strong>
                  {formatCompact(data.protocolDistribution.reduce((sum, item) => sum + item.value, 0))}
                </strong>
                <span>Total</span>
              </div>
            </div>
      ...
      <section className="reports-grid-bottom">
        <SectionCard
          ...
          subtitle="Two-hour buckets from current traffic series"
          className="reports-heatmap-card"
        >
            ...
            {heatmap.map((cell) => (
              <div key={cell.label} className="heatmap-cell-wrap">
                <div
                  ...
                  style={{ opacity: Math.max(0.15, cell.value / 100) }}
                />
        ...
        <SectionCard
          ...
          subtitle="Live event and overview correlation"
          className="reports-ip-card"
        >
          <div className="top-ip-list-dense">
            ...
            {data.topSourceIps.length === 0 && !loading ? (
              <div className="placeholder-box">No top offenders available yet.</div>
            ) : null}
          </div>

          <div className="detail-label" style={{ marginTop: 12 }}>
            Recent packets observed in client: {formatCompact(packets.length)}
          </div>
        </SectionCard>
      </section>
    </div>
